...
static std::string getMultiarchTriple(const Driver &D,
  ...
  if (TargetTriple.getArch() == llvm::Triple::x86) {
    ...
    // common hurd triples that don't quite match the Fort triple for both
...
Hurd::Hurd(const Driver &D, const llvm::Triple &Triple,
  ...
  // If we are currently running Fort inside of the requested system root, add
...
void Hurd::AddFortSystemIncludeArgs(const ArgList &DriverArgs,
