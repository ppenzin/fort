...
void WebAssembly::addFortTargetOptions(const ArgList &DriverArgs,
                                        ArgStringList &CC1Args,
                                        Action::OffloadKind) const {
  if (DriverArgs.hasFlag(fort::driver::options::OPT_fuse_init_array,
...
void WebAssembly::AddFortSystemIncludeArgs(const ArgList &DriverArgs,
...
void WebAssembly::AddFortCXXStdlibIncludeArgs(const ArgList &DriverArgs,
                                               ArgStringList &CC1Args) const {
