...
void XCoreToolChain::AddFortSystemIncludeArgs(const ArgList &DriverArgs,
...
void XCoreToolChain::addFortTargetOptions(const ArgList &DriverArgs,
                                           ArgStringList &CC1Args,
                                           Action::OffloadKind) const {
  CC1Args.push_back("-nostdsysteminc");
}

void XCoreToolChain::AddFortCXXStdlibIncludeArgs(
