...
void hexagon::Assembler::ConstructJob(Compilation &C, const JobAction &JA,
  ...
  for (const auto &II : Inputs) {
    ...
    if (types::isLLVMIR(II.getType()))
      ...
      D.Diag(fort::diag::err_drv_no_ast_support)
          << HTC.getTripleString();
...
void HexagonToolChain::addFortTargetOptions(const ArgList &DriverArgs,
...
void HexagonToolChain::AddFortSystemIncludeArgs(const ArgList &DriverArgs,
