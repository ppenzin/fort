...
#ifndef LLVM_FORT_LIB_DRIVER_TOOLCHAINS_MIPS_LINUX_H
#define LLVM_FORT_LIB_DRIVER_TOOLCHAINS_MIPS_LINUX_H
...
#endif // LLVM_FORT_LIB_DRIVER_TOOLCHAINS_MIPS_LINUX_H
