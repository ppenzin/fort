...
#ifndef LLVM_FORT_LIB_DRIVER_TOOLCHAINS_BAREMETAL_H
#define LLVM_FORT_LIB_DRIVER_TOOLCHAINS_BAREMETAL_H
...
public:
  ...
  void AddFortSystemIncludeArgs(const llvm::opt::ArgList &DriverArgs,
