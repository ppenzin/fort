...
#ifndef LLVM_FORT_LIB_DRIVER_TOOLCHAINS_GNU_H
#define LLVM_FORT_LIB_DRIVER_TOOLCHAINS_GNU_H
...
public:
  ...
  /// This is a class to find a viable GCC installation for Fort to
  /// use.
  ///
...
#endif // LLVM_FORT_LIB_DRIVER_TOOLCHAINS_GNU_H
