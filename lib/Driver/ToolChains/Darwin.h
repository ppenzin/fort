...
#ifndef LLVM_FORT_LIB_DRIVER_TOOLCHAINS_DARWIN_H
#define LLVM_FORT_LIB_DRIVER_TOOLCHAINS_DARWIN_H

#include "Cuda.h"
#include "fort/Driver/DarwinSDKInfo.h"
...
public:
  ...
  std::string ComputeEffectiveFortTriple(const llvm::opt::ArgList &Args,
...
/// DarwinFort - The Darwin toolchain used by Fort.
class LLVM_LIBRARY_VISIBILITY DarwinFort : public Darwin {
public:
  DarwinFort(const Driver &D, const llvm::Triple &Triple,
              const llvm::opt::ArgList &Args);
  ...
  void addFortWarningOptions(llvm::opt::ArgStringList &CC1Args) const override;
...
#endif // LLVM_FORT_LIB_DRIVER_TOOLCHAINS_DARWIN_H
