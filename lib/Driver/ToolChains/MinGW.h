...
#ifndef LLVM_FORT_LIB_DRIVER_TOOLCHAINS_MINGW_H
#define LLVM_FORT_LIB_DRIVER_TOOLCHAINS_MINGW_H
...
private:
  ...
  llvm::ErrorOr<std::string> findFortRelativeSysroot();
...
#endif // LLVM_FORT_LIB_DRIVER_TOOLCHAINS_MINGW_H
