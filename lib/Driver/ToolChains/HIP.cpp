...
// Construct a fort-offload-bundler command to bundle code objects for
...
void AMDGCN::constructHIPFatbinCommand(Compilation &C, const JobAction &JA,
  ...
  // Construct fort-offload-bundler command to bundle object files for
  // for different GPU archs.
  ArgStringList BundlerArgs;
  BundlerArgs.push_back(Args.MakeArgString("-type=o"));

  // ToDo: Remove the dummy host binary entry which is required by
  // fort-offload-bundler.
  ...
  llvm::sys::path::append(BundlerPath, "fort-offload-bundler");
...
void HIPToolChain::addFortTargetOptions(
...
void HIPToolChain::addFortWarningOptions(ArgStringList &CC1Args) const {
...
void HIPToolChain::AddFortSystemIncludeArgs(const ArgList &DriverArgs,
                                              ArgStringList &CC1Args) const {
  HostTC.AddFortSystemIncludeArgs(DriverArgs, CC1Args);
}

void HIPToolChain::AddFortCXXStdlibIncludeArgs(const ArgList &Args,
                                                 ArgStringList &CC1Args) const {
