...
void tools::SHAVE::Compiler::ConstructJob(Compilation &C, const JobAction &JA,
  ...
  // mcpu flags, mllvm flags, and Xfort flags.
  // These are spelled the same way in fort and moviCompile.
  Args.AddAllArgsExcept(
      CmdArgs,
      {options::OPT_I_Group, options::OPT_fort_i_Group, options::OPT_std_EQ,
       options::OPT_D, options::OPT_U, options::OPT_f_Group,
       options::OPT_f_fort_Group, options::OPT_g_Group, options::OPT_M_Group,
       options::OPT_O_Group, options::OPT_W_Group, options::OPT_mcpu_EQ,
       options::OPT_mllvm, options::OPT_Xfort},
...
MyriadToolChain::MyriadToolChain(const Driver &D, const llvm::Triple &Triple,
  ...
  // If a target of 'sparc-myriad-elf' is specified to fort, it wants to use
  ...
  default:
    D.Diag(fort::diag::err_target_unsupported_arch)
...
void MyriadToolChain::AddFortSystemIncludeArgs(const ArgList &DriverArgs,
