...
#ifndef LLVM_FORT_LIB_DRIVER_TOOLCHAINS_MYRIAD_H
#define LLVM_FORT_LIB_DRIVER_TOOLCHAINS_MYRIAD_H
...
/// MyriadToolChain - A tool chain using either fort or the external compiler
...
#endif // LLVM_FORT_LIB_DRIVER_TOOLCHAINS_MYRIAD_H
