...
#ifndef LLVM_FORT_DRIVER_TOOL_H
#define LLVM_FORT_DRIVER_TOOL_H
...
public:
  ...
  enum ResponseFileSupport {
    ...
    // all tool input arguments to a file. E.g.: fort, gcc, binutils and MSVC
    // tools.
    RF_Full,
...
public:
  ...
  /// - Fort accepts both UTF8 and UTF16.
  ///
