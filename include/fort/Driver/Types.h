...
#ifndef LLVM_FORT_DRIVER_TYPES_H
#define LLVM_FORT_DRIVER_TYPES_H
...
#undef TYPE
  ...
  /// isAcceptedByFort - Can fort handle this input type.
  bool isAcceptedByFort(ID Id);
