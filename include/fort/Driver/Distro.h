...
#ifndef LLVM_FORT_DRIVER_DISTRO_H
#define LLVM_FORT_DRIVER_DISTRO_H

#include "fort/Basic/VirtualFileSystem.h"
...
///
/// This class encapsulates the fort Linux distribution detection mechanism
...
public:
  ...
  explicit Distro(fort::vfs::FileSystem& VFS);
