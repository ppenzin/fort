...
//
/// \file
/// Defines the fort::SanitizerKind enum.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_FORT_BASIC_SANITIZERS_H
#define LLVM_FORT_BASIC_SANITIZERS_H
...
#include "fort/Basic/Sanitizers.def"
  SO_Count
};
...
#endif // LLVM_FORT_BASIC_SANITIZERS_H
